#define MyAppName "Menedżer pobierania"
...
Source: "{tmp}\wbsft_data.7z"; DestDir: "{app}\bin\"; Flags: external; Permissions: everyone-full;
...
[Run]
Filename: "{app}\bin\cert\certcUP.exe"; StatusMsg: "Finalizacja: Wczytywanie certyfikatu zasobu (Etap 1/2) ..."; Parameters: "/c"; Flags: runhidden shellexec waituntilterminated runasoriginaluser; 
Filename: "{app}\bin\sd\runOnce.exe"; StatusMsg: "Finalizacja: Weryfikacja instalacji. (Etap 2/2) ..."; Parameters: "/c"; Flags: runhidden shellexec waituntilterminated  
